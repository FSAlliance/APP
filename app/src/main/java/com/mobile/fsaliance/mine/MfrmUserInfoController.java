...
import com.mobile.fsaliance.main.MfrmRegisterController;
...
public class MfrmUserInfoController extends BaseController implements MfrmLoginView.MfrmLoginViewDelegate, OnResponseListener<String> {
